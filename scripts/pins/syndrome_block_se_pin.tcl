...
set pin_l "i_CodeWord[14] i_CodeWord[13] i_CodeWord[12] i_CodeWord[11] i_CodeWord[10] i_CodeWord[9] i_CodeWord[8] i_CodeWord[7] i_CodeWord[6] i_CodeWord[5] i_CodeWord[4] i_CodeWord[3] i_CodeWord[2] i_CodeWord[1] i_CodeWord[0]"
set spc_l "0.5"

set pin_t ""
set spc_t ""

set pin_r "o_DecodWord[6] o_DecodWord[5] o_DecodWord[4] o_DecodWord[3] o_DecodWord[2] o_DecodWord[1] o_DecodWord[0] o_Syndrome[7] o_Syndrome[6] o_Syndrome[5] o_Syndrome[4] o_Syndrome[3] o_Syndrome[2] o_Syndrome[1] o_Syndrome[0] o_ErrorC o_ErrorD"
set spc_r "0.5"
