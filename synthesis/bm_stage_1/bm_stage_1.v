...
module bm_stage_1(clk, rst, S1, S2, S3, l1_1, S1_o, S2_o, S3_o);
  ...
  DFFRX2 \l1_1_reg[2] (.RN (rst), .CK (clk), .D (div1[2]), .Q
       (l1_1[2]), .QN (UNCONNECTED));
  DFFRX2 \l1_1_reg[0] (.RN (rst), .CK (clk), .D (div1[0]), .Q
       (l1_1[0]), .QN (UNCONNECTED0));
  DFFRX2 \l1_1_reg[3] (.RN (rst), .CK (clk), .D (div1[3]), .Q
       (l1_1[3]), .QN (UNCONNECTED1));
  DFFRX2 \l1_1_reg[1] (.RN (rst), .CK (clk), .D (div1[1]), .Q
       (l1_1[1]), .QN (UNCONNECTED2));
  DFFRX2 \S2_o_reg[1] (.RN (rst), .CK (clk), .D (S2[1]), .Q (S2_o[1]),
       .QN (UNCONNECTED3));
  DFFRX2 \S3_o_reg[0] (.RN (rst), .CK (clk), .D (S3[0]), .Q (S3_o[0]),
       .QN (UNCONNECTED4));
  DFFRX2 \S1_o_reg[0] (.RN (rst), .CK (clk), .D (S1[0]), .Q (S1_o[0]),
       .QN (UNCONNECTED5));
  DFFRX2 \S1_o_reg[3] (.RN (rst), .CK (clk), .D (S1[3]), .Q (S1_o[3]),
       .QN (UNCONNECTED6));
  DFFRX2 \S2_o_reg[2] (.RN (rst), .CK (clk), .D (S2[2]), .Q (S2_o[2]),
       .QN (UNCONNECTED7));
  DFFRX2 \S3_o_reg[3] (.RN (rst), .CK (clk), .D (S3[3]), .Q (S3_o[3]),
       .QN (UNCONNECTED8));
  DFFRX2 \S2_o_reg[3] (.RN (rst), .CK (clk), .D (S2[3]), .Q (S2_o[3]),
       .QN (UNCONNECTED9));
  DFFRX2 \S1_o_reg[2] (.RN (rst), .CK (clk), .D (S1[2]), .Q (S1_o[2]),
       .QN (UNCONNECTED10));
  DFFRX2 \S2_o_reg[0] (.RN (rst), .CK (clk), .D (S2[0]), .Q (S2_o[0]),
       .QN (UNCONNECTED11));
  DFFRX2 \S1_o_reg[1] (.RN (rst), .CK (clk), .D (S1[1]), .Q (S1_o[1]),
       .QN (UNCONNECTED12));
  DFFRX2 \S3_o_reg[2] (.RN (rst), .CK (clk), .D (S3[2]), .Q (S3_o[2]),
       .QN (UNCONNECTED13));
  DFFRX2 \S3_o_reg[1] (.RN (rst), .CK (clk), .D (S3[1]), .Q (S3_o[1]),
       .QN (UNCONNECTED14));
endmodule
